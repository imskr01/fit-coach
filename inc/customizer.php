...
function fitcoach_theme_customizer( $wp_customize ) {
	...
	// Add Footer Section
	$wp_customize->add_section( 'fitcoach-classes' , array(
    	'title' => __( 'Classes', 'fitcoach' ),
    	'priority' => 33, 
    	'description' => __( 'Customize your classes page', 'fitcoach' )   
	) );
	
	// Class Title
	$wp_customize->add_setting( 'class_currency', 
	array(        
		'default' => '&#36;',
		'sanitize_callback' => 'fitcoach_sanitize_text',
	));

	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'class_currency', array(
		'label'    => __( 'Class Currency', 'fitcoach' ),
		'section'  => 'fitcoach-classes', 
		'settings' => 'class_currency', 
		'priority'   => 1
	)));
